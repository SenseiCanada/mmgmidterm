...
namespace Articy.Mmgmidterm.Features
{
    ...
    public class DefaultExtendedCharacterFeatureFeature : IArticyBaseObject, IPropertyProvider
    {
        ...
        {
            Articy.Mmgmidterm.Features.DefaultExtendedCharacterFeatureFeature newClone = ((Articy.Mmgmidterm.Features.DefaultExtendedCharacterFeatureFeature)(aClone));
            if ((mMotivation != null))
            {
        ...
        {
            Articy.Mmgmidterm.Features.DefaultExtendedCharacterFeatureFeature clone = new Articy.Mmgmidterm.Features.DefaultExtendedCharacterFeatureFeature();
