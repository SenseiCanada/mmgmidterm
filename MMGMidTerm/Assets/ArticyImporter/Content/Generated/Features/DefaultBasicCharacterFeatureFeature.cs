...
namespace Articy.Mmgmidterm.Features
{
    ...
    public class DefaultBasicCharacterFeatureFeature : IArticyBaseObject, IPropertyProvider
    {
        ...
        {
            Articy.Mmgmidterm.Features.DefaultBasicCharacterFeatureFeature newClone = ((Articy.Mmgmidterm.Features.DefaultBasicCharacterFeatureFeature)(aClone));
            newClone.Age = Age;
            if ((mSpecies != null))
            {
        ...
        {
            Articy.Mmgmidterm.Features.DefaultBasicCharacterFeatureFeature clone = new Articy.Mmgmidterm.Features.DefaultBasicCharacterFeatureFeature();
